...
let productList;
const fetchProductList = () => __awaiter(void 0, void 0, void 0, function* () {
    const responce = yield fetch("https://fakestoreapi.com/products");
...
const filterSort = () => {
  ...
  <ul class="dropdown-menu sortdropdown-menu">
    ...
    landing === null || landing === void 0 ? void 0 : landing.appendChild(sort_div);
...
const filterByRating = () => {
  ...
  <ul class="dropdown-menu filterdropdown-menu">
    ...
    landing === null || landing === void 0 ? void 0 : landing.appendChild(filter_div);
    const dropdownButton = document.querySelector(".dropdown .btn");
    ...
    dropdownMenu.forEach((item, index) => {
        item.addEventListener('click', () => {
            ...
            const filter_ProductList = productList.filter((item) => item.rating.rate >= parseInt(selectedValue[2]));
...
const decCount = (id, itemprice) => {
    ...
    if (parseInt(val.innerHTML) > 0) {
        ...
        if (num == 0) {
            ...
            console.log(document.getElementById(`addToCart${id}`).innerText);
            document.getElementById(`addToCart${id}`).innerText = `Add to cart`;
        }
        else {
            console.log(num);
            const btn_updated = `
