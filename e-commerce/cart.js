   ...
   <thead><tr>
    ...
    <th class="w-25">Price</th>
        ...
        for (let idx of cartItems) {
            ...
            if (count != null) {
                const productstring = `<tr><td ><a href="./product.html?id=${product === null || product === void 0 ? void 0 : product.id}"><img src ="${product === null || product === void 0 ? void 0 : product.image}" class="cartproductimg"></a></td>
                ...
                <button type= "button" class="plus btn btn-success" onClick = "incCount(${product === null || product === void 0 ? void 0 : product.id},${product === null || product === void 0 ? void 0 : product.price})">+</button></td>
                </div>
                <td id="totalPrice${product === null || product === void 0 ? void 0 : product.id}" class="w-25">${price}</td></tr>`;
    ...
    const totprice = `<h4>Total Price : ${totalcartitemsprice}</h4>
...
const incCount = (id, itemprice) => {
    ...
    const totalPrice = itemprice * parseFloat(String(num));
